...
export default function AboutPageClient({ experiences }: AboutPageClientProps) {
          ...
          <div className="grid items-center gap-10 md:grid-cols-2 md:gap-16">
            <div className="flex justify-center md:justify-start">
              <div className="relative h-80 w-64 max-w-full sm:h-96 sm:w-72 md:h-96 md:w-80 max-[360px]:h-72 max-[360px]:w-56">
                <div
                  ref={profileImageRef}
                  className="relative h-full w-full cursor-pointer overflow-hidden rounded-2xl shadow-2xl"
                >
                  <Image
                ...
                <ul className="list-disc space-y-4 pl-5 text-[clamp(1rem,1.8vw,1.125rem)] leading-[1.7] max-[360px]:text-[0.95rem]">
                  ...
                  <li className="break-words [overflow-wrap:anywhere]">
                    ...
                    <span className="text-[clamp(1.05rem,2.5vw,1.5rem)] text-[var(--text)]">
                      Passionate Software Developer with 2+ years of experience building personal and open-source
                      projects. Experienced in designing, developing, and deploying applications independently
                    </span>
                  </li>
